...
#### 1. 浮动面板界面 (v0.5.5 全新设计)
- **全屏画布**：主视图默认全屏显示，最大化创作空间
- **浮动工具面板**：左上角按钮控制，包含节点面板、AI引擎、变量管理
- **浮动属性编辑器**：选中节点时自动显示，也可手动打开
- **操作说明面板**：点击问号按钮查看快捷操作指南
- **流畅动画**：面板滑入滑出动画，毛玻璃背景效果

#### 2. 画布交互 (v0.5.5 优化)
- **滚轮缩放**：直接滚动鼠标滚轮缩放画布 (0.3x - 3x)
- **左键拖拽**：点击空白区域拖动平移画布
- **Shift+滚轮**：平移画布（备用方式）
- **缩放按钮**：左下角 + / - / 重置 按钮保留
...
### v0.5.5 (当前) - 2025年2月
- ✅ **浮动面板界面**：左侧工具面板和右侧属性编辑器改为浮动抽屉，主画布全屏显示
- ✅ **画布交互优化**：滚轮直接缩放，左键拖拽平移画布
- ✅ **操作说明面板**：新增帮助按钮，点击查看快捷操作指南
- ✅ **界面更清爽**：最大化创作空间，面板按需显示
